...
void upscale_normative_rect(const uint8_t *const input, int height, int width, int in_stride,
    ...
    if (pad_left) {
        ...
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(tmp_left + i * border_cols), (void*)(in_tl + i * in_stride), border_cols);
    ...
    if (pad_right) {
        ...
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(tmp_right + i * border_cols), (void*)(in_tr + i * in_stride), border_cols);
    ...
    if (pad_left) {
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(in_tl + i * in_stride), (void*)(tmp_left + i * border_cols), border_cols);
        }
        eb_aom_free(tmp_left);
    }
    if (pad_right) {
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(in_tr + i * in_stride), (void*)(tmp_right + i * border_cols), border_cols);
        }
...
void highbd_upscale_normative_rect(const uint8_t *const input, int height, int width, int in_stride,
    ...
    if (pad_left) {
        ...
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(tmp_left + i * border_cols), (void*)(in_tl + i * in_stride), border_size);
    ...
    if (pad_right) {
        ...
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(tmp_right + i * border_cols), (void*)(in_tr + i * in_stride), border_size);
    ...
    if (pad_left) {
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(in_tl + i * in_stride), (void*)(tmp_left + i * border_cols), border_size);
        }
        eb_aom_free(tmp_left);
    }
    if (pad_right) {
        for (int i = 0; i < height; i++) {
            eb_memcpy((void*)(in_tr + i * in_stride), (void*)(tmp_right + i * border_cols), border_size);
        }
        eb_aom_free(tmp_right);
    }
}

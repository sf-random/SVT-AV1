...
void generate_nsq_mv(MeContext *context_ptr) {
    ...
    p_best_mv16x8[2]  = p_best_mv16x16[2];// p_sad8x8[4] < p_sad8x8[5] ? p_best_mv8x8[4] : p_best_mv8x8[5];
    p_best_mv16x8[3]  = p_best_mv16x16[3];// p_sad8x8[6] < p_sad8x8[7] ? p_best_mv8x8[6] : p_best_mv8x8[7];
    p_best_mv16x8[4]  = p_best_mv16x16[4];// p_sad8x8[8] < p_sad8x8[9] ? p_best_mv8x8[8] : p_best_mv8x8[9];
    p_best_mv16x8[5]  = p_best_mv16x16[5];// p_sad8x8[10] < p_sad8x8[11] ? p_best_mv8x8[10] : p_best_mv8x8[11];
    p_best_mv16x8[6]  = p_best_mv16x16[6];// p_sad8x8[12] < p_sad8x8[13] ? p_best_mv8x8[12] : p_best_mv8x8[13];
    p_best_mv16x8[7]  = p_best_mv16x16[7];// p_sad8x8[14] < p_sad8x8[15] ? p_best_mv8x8[14] : p_best_mv8x8[15];
    p_best_mv16x8[8]  = p_best_mv16x16[0];// p_sad8x8[16] < p_sad8x8[17] ? p_best_mv8x8[16] : p_best_mv8x8[17];
    p_best_mv16x8[9]  = p_best_mv16x16[1];// p_sad8x8[18] < p_sad8x8[19] ? p_best_mv8x8[18] : p_best_mv8x8[19];
    p_best_mv16x8[10] = p_best_mv16x16[2];// p_sad8x8[20] < p_sad8x8[21] ? p_best_mv8x8[20] : p_best_mv8x8[21];
    p_best_mv16x8[11] = p_best_mv16x16[3];// p_sad8x8[22] < p_sad8x8[23] ? p_best_mv8x8[22] : p_best_mv8x8[23];
    p_best_mv16x8[12] = p_best_mv16x16[4];// p_sad8x8[24] < p_sad8x8[25] ? p_best_mv8x8[24] : p_best_mv8x8[25];
    p_best_mv16x8[13] = p_best_mv16x16[5];// p_sad8x8[26] < p_sad8x8[27] ? p_best_mv8x8[26] : p_best_mv8x8[27];
    p_best_mv16x8[14] = p_best_mv16x16[6];// p_sad8x8[28] < p_sad8x8[29] ? p_best_mv8x8[28] : p_best_mv8x8[29];
    ...
    p_best_mv16x8[17] = p_best_mv16x16[9 ];// p_sad8x8[34] < p_sad8x8[35] ? p_best_mv8x8[34] : p_best_mv8x8[35];
    p_best_mv16x8[18] = p_best_mv16x16[10];// p_sad8x8[36] < p_sad8x8[37] ? p_best_mv8x8[36] : p_best_mv8x8[37];
    p_best_mv16x8[19] = p_best_mv16x16[11];// p_sad8x8[38] < p_sad8x8[39] ? p_best_mv8x8[38] : p_best_mv8x8[39];
    p_best_mv16x8[20] = p_best_mv16x16[12];// p_sad8x8[40] < p_sad8x8[41] ? p_best_mv8x8[40] : p_best_mv8x8[41];
    p_best_mv16x8[21] = p_best_mv16x16[13];// p_sad8x8[42] < p_sad8x8[43] ? p_best_mv8x8[42] : p_best_mv8x8[43];
    p_best_mv16x8[22] = p_best_mv16x16[14];// p_sad8x8[44] < p_sad8x8[45] ? p_best_mv8x8[44] : p_best_mv8x8[45];
    p_best_mv16x8[23] = p_best_mv16x16[15];// p_sad8x8[46] < p_sad8x8[47] ? p_best_mv8x8[46] : p_best_mv8x8[47];
    p_best_mv16x8[24] = p_best_mv16x16[8 ];// p_sad8x8[48] < p_sad8x8[49] ? p_best_mv8x8[48] : p_best_mv8x8[49];
    p_best_mv16x8[25] = p_best_mv16x16[9 ];// p_sad8x8[50] < p_sad8x8[51] ? p_best_mv8x8[50] : p_best_mv8x8[51];
    p_best_mv16x8[26] = p_best_mv16x16[10];// p_sad8x8[52] < p_sad8x8[53] ? p_best_mv8x8[52] : p_best_mv8x8[53];
    p_best_mv16x8[27] = p_best_mv16x16[11];// p_sad8x8[54] < p_sad8x8[55] ? p_best_mv8x8[54] : p_best_mv8x8[55];
    p_best_mv16x8[28] = p_best_mv16x16[12];// p_sad8x8[56] < p_sad8x8[57] ? p_best_mv8x8[56] : p_best_mv8x8[57];
    p_best_mv16x8[29] = p_best_mv16x16[13];// p_sad8x8[58] < p_sad8x8[59] ? p_best_mv8x8[58] : p_best_mv8x8[59];
    p_best_mv16x8[30] = p_best_mv16x16[14];// p_sad8x8[60] < p_sad8x8[61] ? p_best_mv8x8[60] : p_best_mv8x8[61];
    ...
    p_best_mv32x8[1]  = p_best_mv32x32[1];//(p_sad8x8[2] + p_sad8x8[3]) < (p_sad16x16[6] + p_sad8x8[7]) ? p_best_mv16x8[1] : p_best_mv16x8[3];
    p_best_mv32x8[2]  = p_best_mv32x32[0];//(p_sad8x8[8] + p_sad8x8[9]) < (p_sad16x16[12] + p_sad8x8[13]) ? p_best_mv16x8[4] : p_best_mv16x8[6];
    p_best_mv32x8[3]  = p_best_mv32x32[1];//(p_sad8x8[10] + p_sad8x8[11]) < (p_sad16x16[14] + p_sad8x8[15]) ? p_best_mv16x8[5] : p_best_mv16x8[7];
    p_best_mv32x8[4]  = p_best_mv32x32[0];//(p_sad8x8[16] + p_sad8x8[17]) < (p_sad16x16[20] + p_sad8x8[21]) ? p_best_mv16x8[8] : p_best_mv16x8[10];
    p_best_mv32x8[5]  = p_best_mv32x32[1];//(p_sad8x8[18] + p_sad8x8[19]) < (p_sad16x16[22] + p_sad8x8[23]) ? p_best_mv16x8[9] : p_best_mv16x8[11];
    p_best_mv32x8[6]  = p_best_mv32x32[0];//(p_sad8x8[24] + p_sad8x8[25]) < (p_sad16x16[28] + p_sad8x8[29]) ? p_best_mv16x8[12] : p_best_mv16x8[14];
    ...
    p_best_mv32x8[9]  = p_best_mv32x32[3];//(p_sad8x8[34] + p_sad8x8[36]) < (p_sad16x16[38] + p_sad8x8[39]) ? p_best_mv16x8[17] : p_best_mv16x8[19];
    p_best_mv32x8[10] = p_best_mv32x32[2];//(p_sad8x8[40] + p_sad8x8[42]) < (p_sad16x16[44] + p_sad8x8[45]) ? p_best_mv16x8[20] : p_best_mv16x8[22];
    p_best_mv32x8[11] = p_best_mv32x32[3];//(p_sad8x8[41] + p_sad8x8[43]) < (p_sad16x16[46] + p_sad8x8[47]) ? p_best_mv16x8[21] : p_best_mv16x8[23];
    p_best_mv32x8[12] = p_best_mv32x32[2];//(p_sad8x8[48] + p_sad8x8[49]) < (p_sad16x16[52] + p_sad8x8[53]) ? p_best_mv16x8[24] : p_best_mv16x8[26];
    p_best_mv32x8[13] = p_best_mv32x32[3];//(p_sad8x8[50] + p_sad8x8[51]) < (p_sad16x16[54] + p_sad8x8[55]) ? p_best_mv16x8[25] : p_best_mv16x8[27];
    p_best_mv32x8[14] = p_best_mv32x32[2];//(p_sad8x8[56] + p_sad8x8[57]) < (p_sad16x16[60] + p_sad8x8[61]) ? p_best_mv16x8[28] : p_best_mv16x8[30];

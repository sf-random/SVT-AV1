...
void md_sq_motion_search_controls(PictureControlSet *pcs_ptr, ModeDecisionContext *mdctxt, uint8_t md_sq_mv_search_level) {
    ...
    case 1:
        ...
        md_sq_motion_search_ctrls->sparse_search_area_width  = 50;
        md_sq_motion_search_ctrls->sparse_search_area_height = 50;

        md_sq_motion_search_ctrls->max_sparse_search_area_width  = 500;
        md_sq_motion_search_ctrls->max_sparse_search_area_height = 500;
